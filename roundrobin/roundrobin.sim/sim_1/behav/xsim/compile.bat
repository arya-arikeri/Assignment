...
REM
REM Generated by Vivado on Tue Nov 04 19:44:21 +0530 2025
...
echo "xvlog --incr --relax -prj rra_tb_vlog.prj"
call xvlog  --incr --relax -prj rra_tb_vlog.prj -log xvlog.log
